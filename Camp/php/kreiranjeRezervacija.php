    ...
    if (isset($_POST['dugme']))
    {
        if ($_SESSION['Nivo'] < 6)
        {
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <input class="form-control text-box single-line" id="RedniBrojMesta" readonly name="RedniBrojMesta" type="text" value="<?php echo $RedniBrojMesta ?>">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <input class="form-control text-box single-line" id="SatorPrikolica" readonly name="SatorPrikolica" type="number" value="<?php echo $SatorPrikolica ?>">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <input class="form-control text-box single-line" id="DatumPocetka" readonly name="DatumPocetka" onchange="OnChangeEvent();" type="date" value="<?php echo $DatumPocetka ?>">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <input class="form-control text-box single-line" readonly name="DatumZavrsetka" width="50" type="date" value="<?php echo $DatumZavrsetka ?>">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <input class="form-control text-box single-line" readonly id="BrojKampera" name="BrojKampera" type="number" value="<?php echo $BrojKampera ?>">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <select class="form-control select" data-val="true" required data-val-required="Morate odabrati gosta." id="Gost" name="Gost">
                        ...
                        {
                            ?>
                            <option value="<?php echo $red['SifraGosta'] ?>"><?php echo $red['Ime'] . '&nbsp' . $red['Prezime'] . '&nbsp' . $red['BrojLicneKarte'] ?></option><br>
                            <?php
                        } ?>
                    </select>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <textarea class="form-control textarea" id="Napomena" name="Napomena" id="Napomena"></textarea>
                </div>
            </div>
            <br><br><br>
            <div class="form-group">
        ...
        {
            $upit = "SELECT * FROM gost WHERE KorisnikID = " . $_SESSION['ID'];
            $rez = $mysqli->query($upit);  ?>
            ...
            <div class="form-group">
                <label class="control-label col-md-2" for="DatumZavrsetka">Datum zavrsetka</label>
                <div class="col-md-10">
                    <input class="form-control text-box single-line" readonly name="DatumZavrsetka" type="date" value="<?php echo $DatumZavrsetka ?>">
                </div>
            </div>
