...
if (isset($_SESSION['Nivo']))
{
    ...
    if(isset($_POST['dugme']) && $_POST['dugme'] == "sacuvaj")
    {
        ...
        {
            $upit2 = "INSERT INTO rezervacija (RedniBrojMesta, SatorPrikolica, DatumPocetka, DatumZavrsetka, BrojKampera, StatusRezervacije, KorisnikID, SifraGosta, Napomena) VALUES ('" . $_POST['RedniBrojMesta'] . "'," . $_POST['SatorPrikolica'] . ",'" . $_POST['DatumPocetka'] . "','" . $_POST['DatumZavrsetka'] . "','" . $_POST['BrojKampera'] . "','" . $_POST['StatusRezervacije'] . "'," . $_SESSION['ID'] . ",'" . $_POST['Gost'] . "','" . $_POST['Napomena'] . "')";
