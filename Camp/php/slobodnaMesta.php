...
if(isset($_SESSION['Nivo']))
{
    ...
    if(isset($_POST['dugme']) && $_POST['dugme']=="PretraziSat")    
    {
        if(isset($_POST['BrojKampera']) && isset($_POST['DatumPocetka']) && isset($_POST['DatumZavrsetka']))
        {
            ...
            $upit = "SELECT * FROM smestaj WHERE SatorPrikolica=0 AND Obrisan=0 AND Rentira = ". $Rentira ." AND Kapacitet >= ". $BrojKampera ." AND RedniBrojMesta NOT IN (SELECT RedniBrojMesta FROM rezervacija WHERE (StatusRezervacije = 'Cekanje' OR StatusRezervacije = 'Aktivna') AND ((DatumPocetka BETWEEN '" .$DatumPocetka. "' AND '" .$DatumZavrsetka. "') OR (DatumZavrsetka BETWEEN '" .$DatumPocetka. "' AND '" .$DatumZavrsetka. "'))) ";   
    ...
    {  
        if(isset($_POST['BrojKampera']) && isset($_POST['DatumPocetka']) && isset($_POST['DatumZavrsetka']))
        {
            ...
            $upit2 = "SELECT * FROM smestaj WHERE SatorPrikolica=1 AND Obrisan=0 AND Rentira = ". $Rentira ." AND StrujaPrikljucak = ". $StrujaPrikljucak ." AND VodaPrikljucak = ". $VodaPrikljucak ." AND RedniBrojMesta NOT IN (SELECT RedniBrojMesta FROM rezervacija WHERE (StatusRezervacije = 'Cekanje' OR StatusRezervacije = 'Aktivna') AND ((DatumPocetka BETWEEN '" .$DatumPocetka. "' AND '" .$DatumZavrsetka. "') OR (DatumZavrsetka BETWEEN '" .$DatumPocetka. "' AND '" .$DatumZavrsetka. "'))) "; 
            ...
            <form action="kreiranjeRezervacije.php" method="post">
                ...
                if($rez2->num_rows > 0){
                    while($red2=$rez2->fetch_assoc())
                        {   ?>
                            <h2>Dostupna mesta za prikolice za unete parametre</h2>
                            <br>
                            <fieldset>
                                <legend><h4><strong><?php echo $red2['Tip'];?></strong></h4></legend>  
                                <div class="form-group">
                                    <label class="control-label col-md-2" for="RedniBrojMesta">Redni broj mesta</label>
                                    <div class="col-md-10">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-2" for="SatorPrikolica">Sator / Prikolica</label>
                                    <div class="col-md-10">
                                        <input readonly class="form-control text-box single-line" id="SatorPrikolica" name="SatorPrikolica" type="number" value="<?php echo $red2['SatorPrikolica'] ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-2" for="Rentira">Rentira</label>
                                    <div class="col-md-10">
                                        <input readonly class="form-control text-box single-line" id="Rentira" name="Rentira" type="text" value="<?php echo $red2['Rentira'] ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input readonly class="form-control text-box single-line" id="StrujaPrikljucak" name="StrujaPrikljucak" type="text" value="<?php echo $red2['StrujaPrikljucak'] ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input readonly class="form-control text-box single-line" id="VodaPrikljucak" name="VodaPrikljucak" type="text" value="<?php echo $red2['VodaPrikljucak'] ?>">
                                    </div>
                                </div>
